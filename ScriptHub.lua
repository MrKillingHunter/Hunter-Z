...
OrionLib:MakeNotification({
	Name = "Hunter Z Scripthub Loaded",
...
local Window = OrionLib:MakeWindow({IntroText = "Script Hub - Hunter Z",Name = "Script Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "HunterZScriptHub"})
...
NextPage.Text = "I know that some of these Animations are not really rare, but they were worth including. If you guys liked this GUI and found it interesting like the original post on my WRD : Simplexity"
...
PopularTab:AddButton({
	Name = "New Ice Hub",
	Callback = function()
        loadstring(game:HttpGet('loadstring(game:HttpGet("https://raw.githubusercontent.com/IceMael7/NewIceHub/main/Brookhaven"))()'))()
  	end    
})
...
PopularTab:AddButton({
	Name = "SX Chat logger cracked",
	Callback = function()
        OrionLib:MakeNotification({
            Name = "Cracked & Modded by Simplexity",
            Content = "Couldnt access : chat.lua. Error : Access denied.",
            Image = "rbxassetid://4483345998",
            Time = 5
        })
  	end    
...
MobileTab:AddButton({
	Name = "Mobile Admin",
	Callback = function()
        loadstring(game:HttpGet('https://pastebin.com/raw/pNY4DsUx'))()
  	end    
})
